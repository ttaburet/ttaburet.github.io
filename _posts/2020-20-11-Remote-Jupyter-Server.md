---
layout: distill
title: Setting-up a remote jupyter server using SSH
description: Details of the steps that allowed me to run jupyter notebooks elsewhere than on my laptop but from my laptop.
date: 2020-11-17
